...
import com.example.wheelify.databinding.ItemListBinding
import com.example.wheelify.ui.detail.DetailActivity

class PopularNewsAdapter : ListAdapter<ArticlesItem, PopularNewsAdapter.NewsViewHolder>(DIFF_CALLBACK) {
